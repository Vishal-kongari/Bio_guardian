...
# ✅ Load Models
species_model = tf.keras.models.load_model("wildlife_species_model.h5")
tiger_model = tf.keras.models.load_model("py/tiger_recognition_model.h5")
